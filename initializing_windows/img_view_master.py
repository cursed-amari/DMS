# Form implementation generated from reading ui file '.\img_view_master.ui'
#
...
"}")
        ...
        self.label_name_app_2.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.graphicsView_img.setMinimumSize(QtCore.QSize(0, 510))
        ...
        self.frame_navigate = QtWidgets.QFrame(self.img)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(100)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frame_navigate.sizePolicy().hasHeightForWidth())
        self.frame_navigate.setSizePolicy(sizePolicy)
        self.frame_navigate.setMinimumSize(QtCore.QSize(261, 0))
        ...
        self.horizontalLayout_2.addWidget(self.frame_navigate)
...
class MasteWindowViewerShow(QtWidgets.QMainWindow, MasterViewer):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
