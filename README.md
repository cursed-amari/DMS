...
Инициативы противников рассчитана случайно с учётом модификатора.  
...
Что бы добавить главу введите название в после в верхнем левом углу и нажмите кнопку *add*
...
**Изображения должны быть в формате png jpeg и лежать в папке images**  
...
Кнопка обновления справа от списка, обновит список находящихся в папке файлов
___
...
Выберите качество магазины и его типа из списков в центре и нажмите *Generate*  
