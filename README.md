...
В правой части окна находится список локальной музыки  
Чтобы в списке отображалась музыка, вам требуется предварительно поместить её в папку *music*  
Музыка должна быть в формате: mp3, ogg  
Что бы прослушать музыку  
Выберите её из списка и нажмите play(двойной клик по музыке так же её запустит)  
Кнопка stop остановит запись
>Настоятельно рекомендуется использовать короткие записи.  
>Мною, как мастером, это используется следующим образом.  
> Здесь я включаю звуки, по типу звук открывшейся двери или звук разбитого бокала
___
<a id="rules"></a>
## Правила ##  
...
Для того, чтобы разместить токены на изображении, укажите нужное количество в правой части основного окна.  
...
А так же перемещать токены при помощи уменьшенной версии окна просмотра  
*Которое появится при открытии изображения*  
Что бы увеличить или уменьшить изображение в маленьком окне просмотра  
воспользуйтесь кнопками + и -
![img.small_view](read_me_img/img_viewer.small_view_window.png)
  
Вы можете перетаскивать токены, как в большом, так и в маленьком окне!  
![img.img_viewer.example](read_me_img/img_viewer.example.token.png)  
___
